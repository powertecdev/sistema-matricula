...
export const paginationSchema = z.object({ page: z.number({ coerce: true }).int().min(1).default(1), limit: z.number({ coerce: true }).int().min(1).max(100).default(10), search: z.string().optional() });